...
export function QuizzesListPage({ quizzes, basePath = '/quiz' }: QuizzesListPageProps) {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      {/* Quizzes Section com mais espaçamento */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {quizzes.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
              {quizzes.map((quiz) => (
                <div key={quiz.id} className="bg-white rounded-xl p-6 md:p-8 shadow-md hover:shadow-lg transition border border-gray-100">
      ...
      {/* Features Section com mais espaçamento e melhor contraste */}
      <section className="py-16 md:py-20 px-4 md:px-8 bg-gray-50 mt-8 md:mt-12">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10">
            <div className="bg-white p-6 md:p-8 rounded-lg shadow-md border border-gray-100">
              ...
              <p className="text-gray-600">Obtenha resultados personalizados em menos de 2 minutos, sem perder tempo com opções irrelevantes.</p>
            </div>
            ...
            <div className="bg-white p-6 md:p-8 rounded-lg shadow-md border border-gray-100">
              ...
              <p className="text-gray-600">Algoritmos avançados para encontrar exatamente o que você precisa, baseado em suas respostas.</p>
            </div>
            ...
            <div className="bg-white p-6 md:p-8 rounded-lg shadow-md border border-gray-100">
              ...
              <p className="text-gray-600">Cada recomendação é adaptada às suas necessidades específicas, com soluções sob medida para você.</p>
            </div>
          </div>
        </div>
      </section>
